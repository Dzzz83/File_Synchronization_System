package com.filesync.client.shared.members;
...
public class AddMemberController {
    ...
    public void initialize() {
        ...
        permissionBox.valueProperty().addListener((obs, oldVal, newVal) -> {
            System.out.println("Permission selected: " + newVal);
        });
        ...
        searchField.textProperty().addListener((obs, oldVal, newVal) -> {
            ...
            currentSearchTask = new Task<List<UserSearchResult>>() {
                @Override
                protected List<UserSearchResult> call() {
            ...
            currentSearchTask.setOnFailed(e -> {
                Platform.runLater(() -> showAlert("Search Error", currentSearchTask.getException().getMessage()));
            });
    ...
    private void addMember() {
        ...
        System.out.println("Adding member: " + username + ", permission: " + perm);
